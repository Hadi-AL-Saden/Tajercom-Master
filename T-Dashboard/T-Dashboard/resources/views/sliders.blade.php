            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sliders Page</h4>
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-top-0">sliders-Name</th>
                                            <th class="border-top-0">sliders-description</th>
                                            <th class="border-top-0">sliders-Image</th>
