                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('update-category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="container">
                                <img class="img" src="{{asset('upload/category/'.$category->category_img)}}" width="80px" height="80px"  alt="User image">
                            </div>
                            <input type="file" name="category_img" value="{{$category->category_img}}"save() class="form-control">
                        </div>
